...
import { edit_profile, CLOUDINARY_UPLOAD_PRESET, CLOUDINARY_UPLOAD_URL } from '../User/UserFunctions';
...
class EditProfile extends React.Component {
  ...
  //   //   this.props.handleToggle(this.state.is_farmer),
  //   //   this.props.handleToggle(this.state.is_vendor)
  //   // )
  // }
            ...
            <div className="card-header">
              <div className="row align-items-center">
                ...
                <form onSubmit={this.onSubmit} className="my-login-validation" noValidate="">
                  <div className="col-12 text-right card1">
