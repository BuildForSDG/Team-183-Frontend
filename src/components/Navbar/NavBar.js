       ...
       <Fragment>
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item " >
             ...
             <li className="nav-item">
              <NavLink to="/blog" className="nav-link" activeClassName="selected">
                Blog
              </NavLink>
            </li>
            <li className="nav-item">
      ...
      <nav className="navbar-wrapper navbar navbar-expand-lg navbar-light " style={{ background: 'orange' }}>
        <NavLink className="navbar-brand" to="/">
          <img
            ...
            src="https://cdn2.iconfinder.com/data/icons/food-and-beverage-02-fill-style-1/64/chicken-roast-whole-baked-cooked-cooking-dinner-512.png"
            alt=""
